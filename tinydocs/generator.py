...
class SiteGenerator:
    def __init__(self, json_path: str, output_dir: str = "docs"):
        ...
        # PackageLoader(package_name, folder_name_inside_package)
        # Assuming your folder structure is: tinydocs/generator.py and tinydocs/templates/
        self.env = Environment(
            loader=PackageLoader('tinydocs', 'templates'),
